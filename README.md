...
The latest version of the library supports GHC 9.14 only. Older versions of `uom-plugin` may work with older compilers:
 - 0.4 works with GHC 9.0, 9.2 and 9.4.
 - There are no versions supporting GHC 8.4 to 8.10 ([#43][i43]).
 - 0.3 and earlier work with the GHC 7.10, 8.0 and 8.2 series.
