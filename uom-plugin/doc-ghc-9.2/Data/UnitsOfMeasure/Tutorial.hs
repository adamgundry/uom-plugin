...
--                   with actual type: GHC.Real.Ratio a0
--     • In the expression: (1 % 1) :: Quantity _ One
-- ...
--
...
--                      with: Base "m"
--       Expected: Quantity a (Base "m")
--         Actual: Quantity a (MkUnit "s")
--       NB: ‘Base’ is a non-injective type family
-- ...
